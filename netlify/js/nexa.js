...
const LANGS = {
    fr: {
        ...
        pProName: 'Pro 🎯', pProPeriod: '/mois',
        pProFeat1: '75 messages / jour', pProFeat2: 'Messages ultra-personnalisés', pProFeat3: 'Dashboard avancé', pProFeat4: 'Support 24/7', pProFeat5: 'API',
        pProBtn: 'Choisir Pro →',
        pProAnnualBadge: '🎁 2 MOIS OFFERTS', pProAnnualName: 'Pro Annuel 🎯', pProAnnualPeriod: '/an',
        pProAnnualFeat1: '75 messages / jour', pProAnnualFeat2: 'Messages ultra-personnalisés', pProAnnualFeat3: 'Dashboard avancé', pProAnnualFeat4: 'Support 24/7', pProAnnualFeat5: 'Économie de €118',
        pProAnnualBtn: 'Choisir Pro Annuel →',
        pAmbName: 'Ambassadeur', pAmbPeriod: '/mois',
        pAmbFeat1: '50 messages / jour', pAmbFeat2: 'Lien d\'affiliation personnel', pAmbFeat3: '20% sur chaque vente générée',
        pAmbBtn: 'Devenir Ambassadeur →',
        ...
        faqQ2: 'Mes données sont-elles sécurisées ?', faqA2: 'Oui. Toutes tes données sont chiffrées et hébergées en sécurité. Rien n\'est revendu, jamais.',
        faqQ3: 'Puis-je annuler ?', faqA3: 'Oui. Sans engagement, sans frais cachés. Résiliation en un clic depuis ton dashboard.',
        faqQ4: 'Quand est-ce que ça fonctionne ?', faqA4: 'Les premiers prospects arrivent dans les 24h suivant l\'activation. Les résultats significatifs dans la première semaine.',
        faqQ5: 'Sur quels réseaux ?', faqA5: 'TikTok et Instagram. LinkedIn, Twitter et YouTube arrivent prochainement.'
    },
    en: {
        ...
        pProName: 'Pro 🎯', pProPeriod: '/month',
        pProFeat1: '75 messages / day', pProFeat2: 'Ultra-personalized messages', pProFeat3: 'Advanced dashboard', pProFeat4: '24/7 support', pProFeat5: 'API',
        pProBtn: 'Choose Pro →',
        pProAnnualBadge: '🎁 2 MONTHS FREE', pProAnnualName: 'Pro Annual 🎯', pProAnnualPeriod: '/year',
        pProAnnualFeat1: '75 messages / day', pProAnnualFeat2: 'Ultra-personalized messages', pProAnnualFeat3: 'Advanced dashboard', pProAnnualFeat4: '24/7 support', pProAnnualFeat5: 'Save €118',
        pProAnnualBtn: 'Choose Pro Annual →',
        pAmbName: 'Ambassador', pAmbPeriod: '/month',
        pAmbFeat1: '50 messages / day', pAmbFeat2: 'Personal affiliate link', pAmbFeat3: '20% on every sale generated',
        pAmbBtn: 'Become an Ambassador →',
        ...
        faqQ2: 'Is my data secure?', faqA2: 'Yes. All your data is encrypted and securely hosted. Nothing is ever resold.',
        faqQ3: 'Can I cancel?', faqA3: 'Yes. No commitment, no hidden fees. Cancel in one click from your dashboard.',
        faqQ4: 'When does it start working?', faqA4: 'The first prospects arrive within 24h of activation. Significant results within the first week.',
        faqQ5: 'On which platforms?', faqA5: 'TikTok and Instagram. LinkedIn, Twitter and YouTube coming soon.'
    },
    cn: {
        ...
        pProName: 'Pro 🎯', pProPeriod: '/月',
        pProFeat1: '每天75条消息', pProFeat2: '超个性化消息', pProFeat3: '高级仪表盘', pProFeat4: '24/7支持', pProFeat5: 'API',
        pProBtn: '选择 Pro →',
        pProAnnualBadge: '🎁 赠送2个月', pProAnnualName: 'Pro 年付 🎯', pProAnnualPeriod: '/年',
        pProAnnualFeat1: '每天75条消息', pProAnnualFeat2: '超个性化消息', pProAnnualFeat3: '高级仪表盘', pProAnnualFeat4: '24/7支持', pProAnnualFeat5: '节省€118',
        pProAnnualBtn: '选择 Pro 年付 →',
        pAmbName: '大使计划', pAmbPeriod: '/月',
        pAmbFeat1: '每天50条消息', pAmbFeat2: '专属推广链接', pAmbFeat3: '每笔销售提成20%',
        pAmbBtn: '成为大使 →',
        ...
        faqQ2: '我的数据安全吗？', faqA2: '是的，所有数据均加密并安全存储，绝不转售。',
        faqQ3: '可以取消吗？', faqA3: '可以，无需承诺，无隐藏费用，在仪表盘一键取消。',
        faqQ4: '什么时候开始见效？', faqA4: '激活后24小时内即可获得首批客户，第一周内可见明显效果。',
        faqQ5: '支持哪些平台？', faqA5: 'TikTok 和 Instagram，LinkedIn、Twitter 和 YouTube 即将上线。'
    }
};
